...
a comma and space in the form of "1a, 1b, 1c, 1d, 2a, 2b (....) 6d, 7a, 7b, 7c, 7d".

Examples:

csSchoolYearsAndGroups(years = 7, groups = 4) ➞ "1a, 1b, 1c, 1d, 2a, 2b, 2c, 2d, 3a, 3b, 3c, 3d, 4a, 
4b, 4c, 4d, 5a, 5b, 5c, 5d, 6a, 6b, 6c, 6d, 7a, 7b, 7c, 7d"
Notes:
...
def csSchoolYearsAndGroups(years, groups):
    ...
    for i in range(years):
        for j in range(groups):
            #turns integer into letter
            school += str(i+1) + chr(ord('`')+(j+1))+", "
    return school[:-2]